...
#define P 5 // total number of process
#define R 3 // total number of resources
...
int main()
{
    ...
    bool marked[P];
    memset(marked, false, sizeof(marked)); // memset() is used to fill a block of memory with a particular value.
